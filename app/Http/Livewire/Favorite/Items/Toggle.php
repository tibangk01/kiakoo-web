...
namespace App\Http\Livewire\Favorite\Items;
...
{
    protected $listeners = ['itemFavoriteToggled' => 'fresh'];
    ...
    public function toggle()
    {
        ...
        $this->emit('itemFavoriteToggled');
    }

    public function render()
    {
        return view('livewire.favorite.items.toggle');
    }
}
